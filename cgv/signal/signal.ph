...
class method_functor<@(i),X,@["T1"; ", "; "T".N_ARG]> : public functor<@(i),@["T1"; ", "; "T".N_ARG]>
{
public:
	typedef signature<@(i),@["T1"; ", "; "T".N_ARG]> S;
...
void connect(signal<@["T1"; ", "; "T".i]>& s, X* ip, void (X::*mp)(@["T1"; ", "; "T".i])) { s.connect(method_functor<@(i),X,@["T1"; ", "; "T".i]>(ip,mp)); }

// disconnect signal from a void method of an object
template <class X, @["typename T1"; ", "; "typename T".i]>
void disconnect(signal<@["T1"; ", "; "T".i]>& s, X* ip, void (X::*mp)(@["T1"; ", "; "T".i])) { s.disconnect(method_functor<@(i),X,@["T1"; ", "; "T".i]>(ip,mp)); }

template <class X, @["typename T1"; ", "; "typename T".N_ARG]>
class const_method_functor<@(i),X,@["T1"; ", "; "T".N_ARG]> : public functor<@(i),@["T1"; ", "; "T".N_ARG]>
{
public:
	typedef signature<@(i),@["T1"; ", "; "T".N_ARG]> S;
...
template <class X, @["typename T1"; ", "; "typename T".i]>
void connect(signal<@["T1"; ", "; "T".i]>& s, X* ip, void (X::*mp)(@["T1"; ", "; "T".i]) const) { s.connect(const_method_functor<@(i),X,@["T1"; ", "; "T".i]>(ip,mp)); }

// disconnect signal from a void const method of an object
template <class X, @["typename T1"; ", "; "typename T".i]>
void disconnect(signal<@["T1"; ", "; "T".i]>& s, X* ip, void (X::*mp)(@["T1"; ", "; "T".i]) const) { s.disconnect(const_method_functor<@(i),X,@["T1"; ", "; "T".i]>(ip,mp)); }
