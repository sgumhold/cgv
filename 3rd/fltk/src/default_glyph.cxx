// "$Id: default_glyph.cxx 7513 2010-04-15 17:19:27Z spitzak $"
//
...
void DefaultGlyph::_draw(const Rectangle& rr) const
{
  ...
  int i = 0;
  // when a non-legacy theme is used we do not draw the outline for inactive labels
...
//
// End of "$Id: default_glyph.cxx 7513 2010-04-15 17:19:27Z spitzak $".
//
