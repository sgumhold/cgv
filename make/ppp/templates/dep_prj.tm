...
@define(     cudaEnabled_tmp=     cudaEnabled)
@define(     cudaOptions_tmp=     cudaOptions)
@define(cudaCodeGeneration_tmp=cudaCodeGeneration)
...
@define(     cudaEnabled=     cudaEnabled_tmp)
@define(cudaCodeGeneration=cudaCodeGeneration_tmp)
@define(     cudaOptions=     cudaOptions_tmp)
