...
bool canvas::get_origin_upper_left() const {
	return origin_upper_left;
}

void canvas::set_origin_upper_left(bool flag) {
	origin_upper_left = flag;
}
...
void canvas::set_view(cgv::render::context& ctx, cgv::render::shader_program& prog) {
	...
	prog.set_uniform(ctx, "origin_upper_left", origin_upper_left);
