...
namespace cgv {
	...
	namespace pointcloud {
		...
		public:
			...
			void initializeDistanceComputation();
		...
		protected:
			...
			//void outerBnB();
			//float innerBnB(float* max_rot_dis_list, translation_node* trans_node_out);
			//float distanceToTarget(const Pnt& p);
		...
		protected: //templated methods
			template<GoICP::DistanceComputationMode DCM>
			inline float distance_to_target(const GoICP::Pnt & p)
			{
				switch (DCM) {
			...
			template<GoICP::DistanceComputationMode DCM>
			inline float innerBnB(float * max_rot_distance_list, translation_node * trans_node_out)
			{
			...
			template<GoICP::DistanceComputationMode DCM>
			inline float icp(mat3 & R_icp, vec3 & t_icp)
			{
