...
#define MOV_GPMF_TRAK_TMCD      MAKEID('t', 'm', 'c', 'd')		// 
...
size_t OpenMP4Source(const char *filename, uint32_t traktype, uint32_t subtype, int32_t flags);
size_t OpenMP4SourceUDTA(const char *filename, int32_t flags);
