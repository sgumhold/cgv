...
public:
	...
	bool init(cgv::render::context& ctx, const sl::data_type& value_type, size_t count, const std::string& unary_predicate);
	bool init(cgv::render::context& ctx, const sl::data_type& value_type, size_t count, const argument_definitions& arguments, const std::string& unary_predicate);
...
private:
	bool resize(cgv::render::context& ctx);
