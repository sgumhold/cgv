...
public:
	inclusive_scan(GroupSize group_size = k_default_group_size) : scan("inclusive_scan", Mode::Inclusive, group_size) {}
};
...
public:
	exclusive_scan(GroupSize group_size = k_default_group_size) : scan("exclusive_scan", Mode::Exclusive, group_size) {}
};
...
public:
	inclusive_scan(GroupSize group_size = k_default_group_size) : scan<T>("inclusive_scan", Mode::Inclusive, group_size) {}
};
...
public:
	exclusive_scan(GroupSize group_size = k_default_group_size) : scan<T>("exclusive_scan", Mode::Exclusive, group_size) {}
};
