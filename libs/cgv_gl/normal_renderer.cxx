...
namespace cgv {
	namespace render {
		...
		bool normal_renderer::build_shader_program(context& ctx, shader_program& prog, const shader_compile_options& options)
		{
			return prog.build_program(ctx, "normal.glpr", options, true);
		}
