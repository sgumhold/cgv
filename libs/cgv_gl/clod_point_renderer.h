...
namespace cgv {
	namespace render {
		...
		public:
			...
			*/
			...
			inline GLuint get_index_buffer() {
				assert(point_id_buffer != 0);
				return point_id_buffer;
			}
		...
		private:
			...
			static void define_vertex_array(context& ctx, GLuint& vertex_array, const GLuint render_buffer, const GLuint point_id_buffer);
		};
