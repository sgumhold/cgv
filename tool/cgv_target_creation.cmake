...
function(cgv_add_target NAME)
	cmake_parse_arguments(
		...
		"SOURCES;PPP_SOURCES;HEADERS;RESOURCES;AUDIO_RESOURCES;SHADER_SOURCES;ADDITIONAL_PRIVATE_DEFINES;ADDITIONAL_PUBLIC_DEFINES;DEPENDENCIES;LINKTIME_PLUGIN_DEPENDENCIES;ADDITIONAL_INCLUDE_PATHS;ADDITIONAL_PRIVATE_INCLUDE_PATHS;ADDITIONAL_LINKER_PATHS;ADDITIONAL_CMDLINE_ARGS;INVOCATION_PROXY"
	)
	...
	set(SHARED_EXPORT_DEFINE "")
	if (NOT IS_STATIC AND CGVARG__OVERRIDE_SHARED_EXPORT_DEFINE)
		set(SHARED_EXPORT_DEFINE "${CGVARG__OVERRIDE_SHARED_EXPORT_DEFINE}")
	else()
		set(SHARED_EXPORT_DEFINE "${NAME_UPPER}_EXPORTS")
	endif()
	target_compile_definitions(${NAME} PRIVATE "${SHARED_EXPORT_DEFINE}")
	# set custom defines
	...
	target_include_directories(${NAME} PRIVATE ${CGVARG__ADDITIONAL_PRIVATE_INCLUDE_PATHS})
	...
	target_include_directories(${NAME_STATIC} PRIVATE ${CGVARG__ADDITIONAL_PRIVATE_INCLUDE_PATHS})
