...
protected:
	...
	std::shared_ptr<trajectory::util::screen_texture_manager> screen_tex_manager;
	trajectory::util::vive_mouse_controller vm_controller;
	...
	cgv::vec3 vt_display_reconfigure_first_pos;
	cgv::vec3 vt_display_reconfigure_second_pos;
	...
	void reconfigure_virtual_display(cgv::vec3 pos);
	...
	cgv::mat4 camera_to_head_matrix[2];
	cgv::mat4 camera_projection_matrix[4];
	cgv::vec2 focal_lengths[4];
	cgv::vec2 camera_centers[4];
	...
	cgv::vec2 extent_texcrd;
	cgv::vec2 center_left;
	cgv::vec2 center_right;
