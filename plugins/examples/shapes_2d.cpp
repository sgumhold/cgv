...
public:
	shapes_2d() : cgv::base::node("Shapes 2D Test") {
		...
		line_renderer = cgv::glutil::generic_renderer(cgv::g2d::canvas::shaders_2d::line);
		spline_renderer = cgv::glutil::generic_renderer(cgv::g2d::canvas::shaders_2d::cubic_spline);
		point_renderer = cgv::glutil::generic_renderer(cgv::g2d::canvas::shaders_2d::circle);
